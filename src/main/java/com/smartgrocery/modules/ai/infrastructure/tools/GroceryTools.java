 ...
 *
 * In Spring AI 1.0.0-M5, tools are defined as standard Function beans
 * and registered with the ChatClient explicitly.
 */
@Slf4j
@Configuration
...
public class GroceryTools {
        ...
        public Function<AddItemRequest, AddItemResult> addItemToGroceryList() {
                return request -> {
                        log.info("Tool called: addItemToGroceryList listId={} item={} qty={} unit={}",
                                        request.listId(), request.itemName(), request.quantity(), request.unit());
                        ...
                        return new AddItemResult(
                                        ...
                                        String.format("Added %s (%.1f %s) to your list", request.itemName(),
        ...
        public Function<RemoveItemRequest, RemoveItemResult> removeItemFromGroceryList() {
                return request -> {
                        log.info("Tool called: removeItemFromGroceryList listId={} item={}", request.listId(),
                                        request.itemName());
                        ...
                        return new RemoveItemResult(
                                        true,
                                        String.format("Removed %s from your list", request.itemName()));
                };
        }
        ...
        public Function<SearchHistoryRequest, PurchaseHistoryResult> searchPurchaseHistory() {
                return request -> {
                        log.info("Tool called: searchPurchaseHistory userId={} item={}", request.userId(),
                                        request.itemName());
