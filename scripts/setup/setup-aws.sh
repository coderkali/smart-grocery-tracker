...
# Usage: ./scripts/setup/setup-aws.sh  (run from project root)
#
...
#
# These are NOT deleted by ./scripts/stop/stop-cluster.sh
...
echo "Run ./scripts/start/start-cluster.sh when you want to start the cluster."
echo ""
